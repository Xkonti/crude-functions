 ...
 * Record ID is auto-generated by SurrealDB.
 */
export interface CodeSourceRow {
  id: RecordId<"codeSource">; // Auto-generated RecordId
  name: string; // Unique source name (used for filesystem directory)
  type: string;
...
export interface CodeSource {
  /** Auto-generated source identifier */
  id: string;
  /** Unique source name (used for filesystem directory) */
  name: string;
  type: CodeSourceType;
