...
description: Get started with Crude Functions
---
...
- **Per-function CORS:** Browser-friendly cross-origin support with automatic preflight handling
- Encryption at rest for API keys and secrets

## Next steps

Check out our [Getting Started](./guides/getting-started) to learn how to install and use Crude Functions.
